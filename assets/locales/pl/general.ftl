...
disable-telemetry-setting = Wyłącz telemetrię
disable-telemetry-setting-description = Blokuj serwery telemetrii gry za pomocą pliku hosts. Dodane wpisy nie są automatycznie usuwane
