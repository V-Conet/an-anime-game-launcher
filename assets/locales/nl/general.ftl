...
disable-telemetry-setting = Telemetrie uitschakelen
disable-telemetry-setting-description = Blokkeer telemetrieservers van het spel via hosts. Toegevoegde vermeldingen worden niet automatisch verwijderd
