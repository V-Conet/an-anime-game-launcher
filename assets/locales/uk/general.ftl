...
disable-telemetry-setting = Вимкнути телеметрію
disable-telemetry-setting-description = Блокувати сервери телеметрії гри через hosts. Додані записи не видаляються автоматично
