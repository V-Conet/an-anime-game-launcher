...
patch-not-available-tooltip = 패치 서버에 연결할 수 없습니다.
...
patch-broken-tooltip = 현재 패치 버전은 손상되었으며, 제대로 작동하지 않습니다.
patch-unsafe-tooltip = 현재 패치 버전은 불안정하며, 사용해서는 안 됩니다.
patch-concerning-tooltip = 현재 패치 버전에 대해 몇 가지 우려 사항이 있습니다.
...
launcher-behavior-description = 게임을 시작할 때 런처 창이 수행해야 할 작업입니다.
