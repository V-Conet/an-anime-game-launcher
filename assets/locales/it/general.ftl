...
disable-telemetry-setting = Disabilita telemetria
disable-telemetry-setting-description = Blocca i server di telemetria del gioco tramite il file hosts. Le voci aggiunte non vengono rimosse automaticamente
